                    ...
                    <div class="w-full max-w-lg mx-auto lg:mx-0 my-auto wow animate__animated animate__fadeIn animated"
                        ...
                        <div class="float-left mb-6 wow animate__animated animate__fadeIn animated"
                            ...
                            <label class="inline-flex text-xs">
                                ...
                                <span class="ml-2">I agree to <a class="underline hover:text-blueGray-500"
                                        href="#">Police privacy</a> and <a class="underline hover:text-blueGray-500"
                                        href="#">Terms of Use</a></span>
                            </label>
                        </div>
                        <button
                            class="transition duration-300 ease-in-out transform hover:-translate-y-1 block w-full p-4 text-center text-xs text-white font-semibold leading-none bg-blue-500 hover:bg-blue-700 rounded">Sign
                            In</button>
