        ...
        <div class="container">
            <div class="max-w-2xl lg:max-w-3xl mx-auto">
                <div class="mb-12 text-center">
                    ...
                    <p class="text-blueGray-400 wow animate__animated animate__fadeInUp animated" data-wow-delay=".5s">
                            ...
                            <div class="w-full lg:w-1/2 px-3 mb-4 lg:mb-0">
                                ...
                                <div>
                                    <label class="flex px-2 bg-blueGray-50 rounded">
                                        ...
                                        <span
                                            class="my-1 ml-auto px-4 py-3 text-xs text-white font-semibold leading-none bg-blueGray-500 hover:bg-blueGray-600 rounded cursor-pointer">
                                            Browse</span>
                                    </label>
                                </div>
                            </div>
