<template>
     <section class="-mt-24 pt-40 pb-12 bg-blueGray-100">
                <div class="container text-center">
                    <h1 class="text-2xl lg:text-4xl font-bold mb-5 wow animate__animated animate__fadeInUp animated">Our Portfolio</h1>
                    <ul class="mx-auto text-gray-500 text-sm lg:text-sm pb-12 wow animate__animated animate__fadeInUp animated">
