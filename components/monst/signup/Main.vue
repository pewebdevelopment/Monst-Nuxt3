                ...
                <div class="container">
                    <div class="flex max-w-md mx-auto flex-col text-center">
                        <div class="mt-12 mb-8 p-8 bg-white rounded shadow">
                            ...
                            <div class="float-left mb-8 wow animate__animated animate__fadeIn animated" data-wow-delay=".1s">
                            ...
                            <div class="w-full mt-12 mx-auto text-center">
                                <p class="text-sm">Already have an account? <a class="inline-block text-xs text-blue-600 hover:text-blue-700 font-semibold leading-none wow animate__animated animate__fadeIn animated" data-wow-delay=".1s" href="login.html">Sign in now</a></p>
                            </div>
                        </div>
                        <div>
