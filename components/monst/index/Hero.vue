     ...
     <section class="xl:bg-contain bg-top bg-no-repeat -mt-24 pt-24" style="background-image: url('assets/imgs/backgrounds/intersect.svg')">
                <div class="container px-4 mx-auto">
                    <div class="pt-12 text-center">
                        <div class="max-w-2xl mx-auto mb-8">
                            <h2 class="text-3xl lg:text-5xl lg:leading-normal mb-4 font-bold font-heading wow animate__animated animate__fadeIn">Committed to People <br />Committed <span class="text-blue-500">to the Future</span></h2>
                ...
                <div class="relative max-w-6xl mt-16 md:mt-8 mb-8 mx-auto">
                    ...
                    <div class="absolute" style="top: 9%; left: 14%; width: 72%; height: 66%">
                        <img class="jump rounded wow animate__animated animate__fadeInUp" src="../../../assets/imgs/placeholders/dashboard.png" alt="" />
                    </div>
                </div>
                <div class="container px-4 mx-auto">
