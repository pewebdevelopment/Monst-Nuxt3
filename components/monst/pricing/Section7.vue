                ...
                <div class="container">
                    <div class="max-w-2xl lg:max-w-3xl mx-auto">
                        <div class="mb-12 text-center">
                            <h2 class="text-4xl font-bold font-heading wow animate__animatedanimated animate__fadeInUp animated" data-wow-delay=".1s">Get in touch!</h2>
                            <p class="text-blueGray-400 wow animate__animatedanimated animate__fadeInUp animated" data-wow-delay=".5s">We will be glad to hear from you</p>
                        </div>
                        <div class="flex flex-wrap -mx-3 text-center">
                            <div class="w-1/2 lg:w-1/3 px-3 mb-12 wow animate__animatedanimated animate__fadeInUp animated" data-wow-delay=".1s">
                            ...
                            <div class="w-1/2 lg:w-1/3 px-3 mb-12 wow animate__animatedanimated animate__fadeInUp animated" data-wow-delay=".3s">
                                <svg class="mb-6 h-8 w-8 mx-auto text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="w-full lg:w-1/3 px-3 mb-12 wow animate__animatedanimated animate__fadeInUp animated" data-wow-delay=".5s">
                                <svg class="mb-6 h-8 w-8 mx-auto text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                        ...
                        <div>
                            <form>
                                <div class="mb-4 text-sm wow animate__animatedanimated animate__fadeInUp animated" data-wow-delay=".1s">
                                    <span class="mr-4 font-semibold">Departament:</span>
                                    <label class="mr-4">
                                        <input class="mr-1" type="radio" name="department" value="1" checked="true" />
                                        <span>Support</span>
                                    </label>
                                    <label>
                                ...
                                <div class="flex flex-wrap mb-4 -mx-3 wow animate__animatedanimated animate__fadeInUp animated" data-wow-delay=".3s">
