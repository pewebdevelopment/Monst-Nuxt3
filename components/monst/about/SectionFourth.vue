                ...
                <div class="container">
                    <div class="max-w-2xl mx-auto text-center">
                        <div class="max-w-md mb-8 mx-auto">
                            <span class="inline-block py-1 px-3 text-xs font-semibold bg-blue-100 text-blue-600 rounded-xl wow animate__animatedanimated animate__fadeInUp" data-wow-delay=".1s">Contact Us</span>
                            <h2 class="mt-2 text-4xl font-bold font-heading wow animate__animatedanimated animate__fadeInUp" data-wow-delay=".s">We will <span class="text-blue-500">be glad</span> to hear from you!</h2>
                        </div>
                        <div>
                            <form>
                                ...
                                <div class="mb-4 wow animate__animatedanimated animate__fadeInUp" data-wow-delay=".3s"><textarea class="w-full h-24 p-4 text-xs font-semibold leading-none resize-none bg-blueGray-50 rounded outline-none" placeholder="Message..."></textarea></div>
                                <div class="mb-4 wow animate__animatedanimated animate__fadeInUp" data-wow-delay=".3s">
